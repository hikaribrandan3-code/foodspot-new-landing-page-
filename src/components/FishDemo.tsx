...
export function FishDemo() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Taco Character */}
        <svg width="140" height="160" viewBox="0 -40 300 350" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Legs with walking animation */}
          <g style={{ animation: "walkLegs 0.6s ease-in-out infinite" }}>
          ...
          {/* Left arm holding pill */}
          <g style={{ transformOrigin: "120px 150px", animation: "armWave 1s ease-in-out infinite" }}>
            <rect x="35" y="130" width="35" height="65" rx="6" fill="#FF69B4" stroke="#D1478B" strokeWidth="3" transform="rotate(-30 52 162)"/>
          </g>
